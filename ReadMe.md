...
It runs as root from a single binary installed on an Android device.  
...
With this setupt, I simple ran system calls as root to avoid getting blocked by SELinux on the devices I was using
